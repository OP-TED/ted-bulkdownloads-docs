...
. From the https://ted.europa.eu/[TED Portal home page], and under "Reuse notices" click on "Developer's corner for Reusers".
...
IMPORTANT:
====
The ftp service is not available on the TED Portal. Archived schema resources can be found via the link in the left-hand menu.
====
